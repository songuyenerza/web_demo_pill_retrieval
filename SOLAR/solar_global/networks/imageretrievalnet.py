...
from SOLAR.solar_global.layers.pooling import MAC, SPoC, GeM, GeMmp, RMAC, Rpool
from SOLAR.solar_global.layers.normalization import L2N, PowerLaw
from SOLAR.solar_global.datasets.genericdataset import ImagesFromList
from SOLAR.solar_global.utils.general import get_data_root
from SOLAR.solar_global.networks.networks import ResNetSOAs
    ...
    with torch.no_grad():
        ...
        with tqdm(total=len(images)) as pbar:
            for i, _input in enumerate(loader):
                print("imagesss", images[i])
                print("_input", _input)
                print("_inputshape", _input.shape)
